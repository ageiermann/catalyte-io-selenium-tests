...
import java.util.List;
  ...
  public class HirePage {
    ...
    // Accordions
    private final By accordionTalent = By.cssSelector("#what-if-i-need-more-than-apprentice-talent .eael-accordion-tab-title");
    private final By accordionIndustries = By.cssSelector("#what-industries-do-you-provide-talent-for .eael-accordion-tab-title");
    private final By accordionHire = By.cssSelector("#how-can-i-hire-catalyte-talent .eael-accordion-tab-title");
